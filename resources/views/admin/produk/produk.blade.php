                ...
                <!-- Table -->
                    <div class="container-fluid py-4">
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-header pb-0d d-flex">
                                        <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start align-items-center mb-4 mb-md-0">
                                            <h6 class="mb-0 text-dark">Tabel Produk</h6>
                                        </div>
                                        <div class="col-12 col-md-6 text-center text-md-end">
                                            <a class="btn bg-gradient-success mb-0 w-100 w-md-auto" href="">
                                                Tambah
                                            </a>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex px-2 py-1">
                                                                <div>
                                                                    <img src="{{ asset('assets/back-end/img/team-2.jpg') }}" class="avatar avatar-sm me-3" alt="user1">
                                                                </div>
                                                        ...
                                                        <td>
                                                            <p class="text-sm font-weight-bold mb-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Debitis, minus.</p>
                                                        </td>
                                                        <td>
                                                            <p class="text-sm font-weight-bold mb-0">Makanan</p>
                                                        </td>
                                                        <td class="align-middle text-sm">
                                                            <p class="text-sm font-weight-bold mb-0">5 <span class="text-xs text-dark">Item</span></p>
                                                        </td>
                                                        <td class="align-middle">
                                                            <span class="text-dark text-xs font-weight-bold">Rp. 500.000</span>
                                                        </td>
                                                        <td class="align-middle">
